...
if (args[0].tag === "OnUse") {
    const magicSignIntro =  `jb2a.magic_signs.circle.02.necromancy.intro.red`
    const magicSignOutro =  `jb2a.magic_signs.circle.02.necromancy.outro.red`
    ...
    let summonOptions = { buttons: [
        {label: "Despair", value: "Despair Shadow Spirit"},
        {label: "Fear", value: "Fear Shadow Spirit"},
        {label: "Fury", value: "Fury Shadow Spirit"}
    ] };
