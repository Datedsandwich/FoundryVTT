...
if (args[0].tag === "OnUse") {
    const magicSignIntro =  `jb2a.magic_signs.circle.02.necromancy.intro.green`
    const magicSignOutro =  `jb2a.magic_signs.circle.02.necromancy.outro.green`
    ...
    let summonOptions = { buttons: [
        {label: "Ghostly", value: "Ghostly Undead Spirit"},
        {label: "Putrid", value: "Putrid Undead Spirit"},
        {label: "Skeletal", value: "Skeletal Undead Spirit"}
    ] };
