...
if (args[0].tag === "OnUse") {
    const magicSignIntro =  `jb2a.magic_signs.circle.02.conjuration.intro.red`
    const magicSignOutro =  `jb2a.magic_signs.circle.02.conjuration.outro.red`
    ...
    let summonOptions = { buttons: [
        {label: "Demon", value: "Demon Fiendish Spirit"},
        {label: "Devil", value: "Devil Fiendish Spirit"},
        {label: "Yugoloth", value: "Yugoloth Fiendish Spirit"}
    ] };
